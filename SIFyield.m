...
data2014 = load('/Volumes/XiYangResearch/Projects/1.SCOPE_HF/4.matlab/hf_hourly_2014_newtimestamp.mat',...
             'GPP',...
             'H',...
             'LE',...
             'sif_hourly',...
...
% print('-dpng','-r300','/Volumes/XiYangResearch/Projects/10.HF_SIF_Synthesis/1.JPG/GPP_SIF_ColorbySZA_ThresholdSunportion06_2014.png')  %APAR0SZALARGER60
% close(gcf)
