...
%    gpp_max_2012(ii,1)      = nanmax(data2012.GPP(data2012.GPP >0 & data2012.doy_hourly>=doy_tmp_2012(ii) & data2012.doy_hourly<(doy_tmp_2012(ii)+1)));
    ...
    sp_daily_2012(ii,1)    = nanmean(data2012.sunportion_hourly(data2012.sunportion_hourly>0 & data2012.doy_hourly>=doy_tmp_2012(ii) & data2012.doy_hourly<doy_tmp_2012(ii)+1));
end
...
%    gpp_max_2013(ii,1)      = nanmax(data2013.GPP(data2013.GPP >0 & data2013.doy_hourly>=doy_tmp_2013(ii) & data2013.doy_hourly<(doy_tmp_2013(ii)+1)));
    ...
    sp_daily_2013(ii,1)    = nanmean(data2013.sunportion_hourly(data2013.sunportion_hourly>0 & data2013.doy_hourly>=doy_tmp_2013(ii) & data2013.doy_hourly<doy_tmp_2013(ii)+1));
...
%    gpp_max_2014(ii,1)      = nanmax(data2014.GPP(data2014.GPP >0 & data2014.doy_hourly>=doy_tmp_2014(ii) & data2014.doy_hourly<(doy_tmp_2014(ii)+1)));
    ...
    sp_daily_2014(ii,1)    = nanmean(data2014.sunportion_hourly(data2014.sunportion_hourly>0 & data2014.doy_hourly>=doy_tmp_2014(ii) & data2014.doy_hourly<doy_tmp_2014(ii)+1));
...
% th   = 0.3;
% sub1 = sp_daily_2012>th;
% sub2 = sp_daily_2013>th;
% sub3 = sp_daily_2014>th;
% 
% 
% figure
% plot(doy_tmp_2012(sub1),sif_daily_2012(sub1),'ro')
% hold on
% plot(doy_tmp_2013(sub2),sif_daily_2013(sub2),'bo')
% plot(doy_tmp_2014(sub3),sif_daily_2014(sub3),'ko')
% hold off
...
% hold off
% 
% print(gcf,'-dpng','-r300','/Volumes/XiYangResearch/Projects/1.SCOPE_HF/1.JPG/newfig/sif_gpp_diffseasons_sif2012modified.png')
% close(gcf)

%% SIF vs. LE
% plot(sif_daily_2012,le_daily_2012,'ro');
% hold on
% 
% plot(sif_daily_2013,le_daily_2013,'bo');
% plot(sif_daily_2014,le_daily_2014,'ko');
% 
% %lsline
% 
% 
...
% 
% % Fit model to data.
% [fitresult, gof]     = fit( sif_daily_2012(~isnan(sif_daily_2012) & ~isnan(le_daily_2012)), le_daily_2012(~isnan(sif_daily_2012) & ~isnan(le_daily_2012)), ft, opts );
% [fitresult2, gof2]   = fit( sif_daily_2013(~isnan(sif_daily_2013) & ~isnan(le_daily_2013)), le_daily_2013(~isnan(sif_daily_2013) & ~isnan(le_daily_2013)), ft, opts );
% [fitresult3, gof3]   = fit( sif_daily_2014(~isnan(sif_daily_2014) & ~isnan(le_daily_2014)), le_daily_2014(~isnan(sif_daily_2014) & ~isnan(le_daily_2014)), ft, opts );
% 
% h   = plot(fitresult);
% h2  = plot(fitresult2);
% h3  = plot(fitresult3);
...
% 
% 
% set(gca,'YLim',[0,max(le_daily_all)],...
%     'FontSize',16);
% legend({'2012';'2013';'2014'})
% xlabel('SIF(mw/m^{2}/nm/sr)','FontSize',20);
...
% hold off
% 
% print(gcf,'-dpng','-r300','/Volumes/XiYangResearch/Projects/1.SCOPE_HF/1.JPG/newfig/sif_le_diffseasons_sif2012modified.png')
% close(gcf)

%% SIF vs. APAR
% plot(sif_daily_2012,apar_daily_2012,'ro');
% hold on
% 
% plot(sif_daily_2013,apar_daily_2013,'bo');
% plot(sif_daily_2014,apar_daily_2014,'ko');
% 
% %lsline
% 
% 
...
% opts.Display = 'Off';
% opts.Robust = 'Off';
% opts.StartPoint = [max(apar_daily_all) 0.5];
% opts.Lower  = [0 0];
% opts.Upper  = [2*max(apar_daily_all) 5];
% 
% % Fit model to data.
% [fitresult, gof]     = fit( sif_daily_2012(~isnan(sif_daily_2012) & ~isnan(apar_daily_2012)), apar_daily_2012(~isnan(sif_daily_2012) & ~isnan(apar_daily_2012)), ft, opts );
% [fitresult2, gof2]   = fit( sif_daily_2013(~isnan(sif_daily_2013) & ~isnan(apar_daily_2013)), apar_daily_2013(~isnan(sif_daily_2013) & ~isnan(apar_daily_2013)), ft, opts );
% [fitresult3, gof3]   = fit( sif_daily_2014(~isnan(sif_daily_2014) & ~isnan(apar_daily_2014)), apar_daily_2014(~isnan(sif_daily_2014) & ~isnan(apar_daily_2014)), ft, opts );
% 
% h   = plot(fitresult);
% h2  = plot(fitresult2);
% h3  = plot(fitresult3);
...
% 
% 
% set(gca,'YLim',[0,max(apar_daily_all)*1.2],...
%     'FontSize',16);
% legend({'2012';'2013';'2014'})
% xlabel('SIF(mw/m^{2}/nm/sr)','FontSize',20);
...
% hold off
% 
% print(gcf,'-dpng','-r300','/Volumes/XiYangResearch/Projects/1.SCOPE_HF/1.JPG/newfig/sif_apar_diffseasons_sif2012modified.png')
% close(gcf)
